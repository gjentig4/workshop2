---
title: "FAQ: What do the settings of a custom field stand for?"
url: "https://support.focus.teamleader.eu/hc/en-150/articles/25692101619217-FAQ-What-do-the-settings-of-a-custom-field-stand-for"
locale: "en-150"
created_at: "2024-06-06T07:54:49Z"
updated_at: "2026-01-05T07:42:54Z"
category: "FAQ"
section: "Settings"
---
...
A general overview of how custom fields are created can be found [here](https://support.focus.teamleader.eu/hc/en-150/articles/25692628832017-How-To-Creating-a-custom-field-in-Teamleader-Focus).
...
Next to adding crucial information, another important part about custom fields is that you can create [segments ](https://support.focus.teamleader.eu/hc/en-150/articles/25690816108305-How-To-Creating-a-segment-in-Teamleader-Focus)based on those fields. This is why it is even more interesting to have a look at the following article.
...
Typing a phone number into this field allows you to click on it, in order to start a call in case you work with one of our VOIP integrations.
...
- You can also fill in those custom fields when you import contacts, which is why we advise you to create them upfront.[ Click here for more information on how to import companies](https://support.focus.teamleader.eu/hc/en-150/articles/25691800529297-How-To-Importing-contacts-and-companies-to-Teamleader-Focus).
...
You can use custom fields to add additional product information. Custom fields are also frequently used [to add item descriptions in different languages](https://support.focus.teamleader.eu/hc/en-150/articles/25690897267601-How-To-Translating-product-descriptions-for-quotations-and-invoices-in-Teamleader-Focus).

 

### Deal

Custom fields on deal level can also be used as limitations when creating a target, but only for field types 'single' or 'multiple selection'. [Learn how you can add targets](https://support.focus.teamleader.eu/hc/en-150/articles/25691312824465-How-To-Adding-Targets).
 

It's not possible to create custom fields for quotations.
...
### 
[*Move *](https://support.focus.teamleader.eu/hc/en-150/articles/25693707105297-Our-MOVE-package)*& *[*GROW *](https://support.focus.teamleader.eu/hc/en-150/articles/25696098299537-Features-per-package-SMART-GROW-FLOW)*features:*
 
...
- Note that orders are not activated by default in Teamleader Focus. You can, however, [activate them by sending us an email](https://support.focus.teamleader.eu/hc/en-150/requests/new?ticket_form_id=25911134514065).
...
### Ticket ([Boost ](https://support.focus.teamleader.eu/hc/en-150/articles/25693667750929-Our-BOOST-package)or [Shared inbox](https://support.focus.teamleader.eu/hc/en-150/articles/25696098299537-Features-per-package-SMART-GROW-FLOW#:~:text=of%20a%20project-,Shared%20inbox,-Time%20to%20introduce))
