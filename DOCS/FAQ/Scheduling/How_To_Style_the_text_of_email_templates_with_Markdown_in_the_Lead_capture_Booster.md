---
title: "How To: Style the text of email templates with Markdown in the Lead capture Booster"
url: "https://support.focus.teamleader.eu/hc/en-150/articles/25695471152273-How-To-Style-the-text-of-email-templates-with-Markdown-in-the-Lead-capture-Booster"
locale: "en-150"
created_at: "2024-06-06T09:31:41Z"
...
Easy, by using [Markdown](https://www.markdownguide.org/basic-syntax/). This help article will guide you on where and how to use Markdown to customise text in the Lead capture Booster.

# Where to customize text with Markdown in the Lead capture Booster?

You can customize the text for meeting templates and for the custom text strings in the waiting room.

 

## Meetings

[Meeting type](https://meeting.teamleader.eu/scheduling): customize the confirmation, reminder and cancellation emails of a specific meeting type.
...
Edit the custom text strings in the [Customization page](https://meeting.teamleader.eu/team/customization/). You can customize the message that a knocking guest will see when **the host is present **in the meeting room and when **the host is not present** in the meeting room.

 

# How to style text with Markdown?

Below we will explain the basics of the Markdown language which you can use in the Lead capture Booster. You can find a more extended guide [at this link](https://www.markdownguide.org/basic-syntax/). Please note that not all the options in that guide will work in the Lead capture Booster (eg. images)!
...
Interested in changing the layout of your emails? Check out [this help article](https://support.focus.teamleader.eu/hc/en-150/articles/25694963991185-FAQ-Can-I-change-the-layout-of-my-meeting-and-invite-emails)!