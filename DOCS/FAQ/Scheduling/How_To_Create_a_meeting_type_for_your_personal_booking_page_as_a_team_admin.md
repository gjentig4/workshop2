---
title: "How To: Create a meeting type for your personal booking page as a team admin"
url: "https://support.focus.teamleader.eu/hc/en-150/articles/25694496632593-How-To-Create-a-meeting-type-for-your-personal-booking-page-as-a-team-admin"
locale: "en-150"
created_at: "2024-06-06T09:04:19Z"
updated_at: "2025-10-07T14:56:25Z"
category: "FAQ"
section: "Scheduling"
---

# How To: Create a meeting type for your personal booking page as a team admin

![A 'How To' tutorial banner featuring a wrench and gear illustration on a light blue background.](https://support.focus.teamleader.eu/hc/article_attachments/25690662955153)

 

[After connecting the Lead capture Booster to your calendar](https://support.focus.teamleader.eu/hc/en-150/sections/25690691796753), you need to create a meeting type or edit one of the default meeting types. You can make several meeting types and choose if you want to show them on your public booking page or send them separately.
...
- 
[Team Admins](https://support.focus.teamleader.eu/hc/en-150/articles/25694676285969-How-To-Create-a-team-meeting-type-as-an-admin)

- 
[Non-admins of the team](https://support.focus.teamleader.eu/hc/en-150/articles/25695163774225-FAQ-Which-team-meeting-settings-can-a-non-admin-of-the-team-change)

 

To create a personal meeting type as a non-admin or as the only team member visit [this help article](https://support.focus.teamleader.eu/hc/en-150/articles/25694606512401-How-To-Create-a-meeting-type-for-your-personal-booking-page)!

 

In this help article, we will explain how to create a personal meeting type for a team admin.

 

**In this help article**

[1. Click on 'Create new'](#1.-Click-on-'Create-new')

[2. Set up the meeting type](#2.-Set-up-the-meeting-type)

[2.1 Meeting type details - basics](#2.1-Meeting-type-details---basics)

[2.2 Meeting type details - advanced settings](#2.2-Meeting-type-details---advanced-settings)

[2.3 Availability](#2.3-Availability)

[2.4 Summary](#2.4-Summary)

[3. Powerful extensions](#3.-Powerful-extensions)

[3.1 Ask questions](#3.1-Ask-questions)

[3.2 Reminders](#3.2-Reminders)

[3.3 Redirect](#3.3-Redirect)

[3.4 Change the email template of this meeting type](#3.4-Change-the-email-template-of-this-meeting-type)

[3.5 Collect payments (optional)](#3.5-Collect-payments-(optional))

[4. Save your meeting type and check how it looks!](#4.-Save-your-meeting-type-and-check-how-it-looks!)

[5. Share or embed your meeting type(s)](#5.-Share-or-embed-your-meeting-type(s))

# 1. Click on 'Create new'

When you've connected your calendar for the first time, the Lead capture Booster will have created 1, 2 or 3 meeting types for you. You can either edit them or create a new one via the green button ‘Create new’.![The Meeting Types overview in the Lead capture Booster, showing personal and team booking options.](https://support.focus.teamleader.eu/hc/article_attachments/25694449483921)
...
Give the meeting type a name. This name will be shown on your booking page so your guests know what type of meeting it is. E.g. ‘Online demo’.When you change the name of your meeting type, this will impact both the meeting type URL and the embedded link of your meeting type.
...
For online meetings, **a meeting room will be automatically generated** for your client after a meeting has been planned. Returning clients will be directed to the same meeting room. The meeting room will be added to your [dashboard](https://meeting.teamleader.eu/dashboard/).
...
In this step you select whether the meeting type is a ‘Personal’ or ‘Team’ meeting. Make sure to select ‘**Personal meeting type**’ so no team members can be added.
...
### ![A meeting booking form in Teamleader Focus with attendee details and invitation options.](https://support.focus.teamleader.eu/hc/article_attachments/25694431480081)
...
Set up several buffers for your meeting type to perfectly optimize your availability for meetings.![Configuration settings for booking availability and meeting buffers in Teamleader Focus.](https://support.focus.teamleader.eu/hc/article_attachments/25694450043281)

 

Need more information on buffers? [Read this advanced article](https://support.focus.teamleader.eu/hc/en-150/articles/25694707637009-How-To-Set-up-the-availability-and-buffer-settings-for-a-meeting-type) on availability and buffers.
...
![The Availability settings section in Teamleader Focus for scheduling.](https://support.focus.teamleader.eu/hc/article_attachments/25694431731601)
...
![Working hours and availability settings in Teamleader Focus](https://support.focus.teamleader.eu/hc/article_attachments/25694413998225)
...
![Setting up working hours for Monday with two time slots in Teamleader Focus.](https://support.focus.teamleader.eu/hc/article_attachments/25694446806929)
...
![The 'Unavailable dates' section in Teamleader Focus with an 'Add dates' button.](https://support.focus.teamleader.eu/hc/article_attachments/25694446900369)
...
![Summary step for creating a meeting type in the Lead Capture booking tool.](https://support.focus.teamleader.eu/hc/article_attachments/25694447075217)

 

In this part you can also select whether this meeting should show on your public booking page or not. If not, you’re able to copy the link of this meeting type in the [Meeting types overview](https://meeting.teamleader.eu/scheduling/appointment-types/?scope=personal).
...
Optionally, select which tag(s) need to be added to your contact.![The 'Ask questions' configuration panel for setting up lead capture forms in Teamleader Focus.](https://support.focus.teamleader.eu/hc/article_attachments/25694465860753)
...
![A form builder interface showing a required telephone number question and an 'Add question' button.](https://support.focus.teamleader.eu/hc/article_attachments/25694414656017)Read more about custom question types [in this help article.](https://support.focus.teamleader.eu/hc/en-150/articles/25695587505553-How-To-What-types-of-questions-can-I-add-to-my-meeting-type)
...
- 60 minutes![Meeting reminder settings in Teamleader Focus for calendar and email notifications.](https://support.focus.teamleader.eu/hc/article_attachments/25694437952913)

If you would like to pick another amount of minutes, you click on Custom and fill in the preferred number. (e.g. 30)![Setting to send an email reminder before a meeting with a numeric input field for minutes.](https://support.focus.teamleader.eu/hc/article_attachments/25694414839569)
...
- Calendar event = an email sent out by the guest's calendar provider (Google, Outlook, ..) with the details of the event and option to add it to their calendar.
...
## 3.5 Collect payments (optional)![Configuration panel for collecting payments when booking a meeting in Teamleader Focus.](https://support.focus.teamleader.eu/hc/article_attachments/25694415072273)

 

You can add a required payment to your meeting type to collect payments using Stripe. Integrate your Lead capture Booster account with Stripe on the integrations page, save your meeting type before doing this! [This help article](https://support.focus.teamleader.eu/hc/en-150/articles/25694941600145-How-To-Integrate-Stripe-and-the-Lead-capture-Booster) shows how to make the integration.
...
Save the meeting type in the page footer. If it’s the first time that you’ve saved the meeting type then you will see a pop-up that gives you the opportunity to test it live on your booking page or go to the meeting types overview.![Success message after creating a new meeting type in Teamleader Focus](https://support.focus.teamleader.eu/hc/article_attachments/25694423328529)
...
Choose **Copy embedded HTML** if you want to copy paste embedded HTML in your website instead of a regular link. Read more about embedding a meeting type [here](https://support.focus.teamleader.eu/hc/en-150/articles/25695019511185-How-To-Embed-a-booking-page-into-your-website).
...
Click on **Create a widge**t if you want to embed your meeting type in a contact widget on your website. In 'Link contact type', the meeting type you created will automatically be selected. Read more about contact widgets [here](https://support.focus.teamleader.eu/hc/en-150/articles/25695401651985-How-To-Using-the-contact-widget-in-the-Lead-capture-Booster).
...
*Note:* Know that the **language** on the booking pages will be automatically selected based on the browser language of the person who’s visiting your booking page. It’s still possible for them though to manually select another language in the top right-hand corner of the booking page.