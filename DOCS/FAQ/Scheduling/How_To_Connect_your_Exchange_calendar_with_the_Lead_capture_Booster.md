---
title: "How To: Connect your Exchange calendar with the Lead capture Booster"
url: "https://support.focus.teamleader.eu/hc/en-150/articles/25694412150929-How-To-Connect-your-Exchange-calendar-with-the-Lead-capture-Booster"
locale: "en-150"
created_at: "2024-06-06T09:02:36Z"
...
4. Fill in the login and server details of the account to which your calendar is linked. Then, agree to the Terms of Use and Privacy Policy.
...
6. Your calendar in Exchange is now linked to the Lead capture Booster.

 

7. All set! **Next step is to create meeting types**. Find out more [here](https://support.focus.teamleader.eu/hc/en-150/articles/25694606512401-How-To-Create-a-meeting-type-for-your-personal-booking-page).

 

# Sync calendar events to Teamleader Focus

Now that you've connected your Exchange Calendar to the Lead capture Booster, you might want to sync your calendar events to your Teamleader Focus calendar as well. In order to do this, you'll need to set up the integration between the Lead capture Booster and Teamleader Focus. Follow these steps:
...
- The calendars that are checked on availability are based on what you selected in the Lead capture Booster (cf. above) and are based on the availability in your Exchange Calendar (not on your availability in Teamleader Focus).

- New events created through a booking in the Lead capture Booster will be visible in both your Exchange Calendar and in the Teamleader Focus calendar.
