---
title: "How To: Enable cookies to use the Lead capture Booster meeting room"
url: "https://support.focus.teamleader.eu/hc/en-150/articles/25694747163921-How-To-Enable-cookies-to-use-the-Lead-capture-Booster-meeting-room"
locale: "en-150"
created_at: "2024-06-06T09:10:01Z"
...
Generally, you want to **make sure that cookies are enabled** in your browser. Cookies are necessary for a smooth meeting!Enable cookies in your browser settings:
...
- 
[Safari](https://support.apple.com/guide/safari/manage-cookies-and-website-data-sfri11471/mac) (mac) / [Safari](https://www.whatismybrowser.com/guides/how-to-enable-cookies/safari-iphone) (iPad/iPhone)
...
- 
Try to open the meeting room in an incognito window or a different browser.If the CSRF error doesn't show, we recommend starting your meeting like this and fixing the issue in the original browser afterward.

- 
**Update your browser and operating system** to the latest version, and check if the CSRF error still happens.

- 
Check in your browser settings/preferences if the error is caused by an extension/add-on. Deactivate extensions/add-ons and refresh the meeting room to find the cause.

- 
If the CSRF error is not caused by an extension/add-on, check the privacy settings in your browser (see below).
...
- 
Search for the domain name of the meeting room and remove all domain-related entries.Eg. if the meeting room URL is [https://cloud.teamleader.eu/team-name/meeting-rooms/name](https://cloud.teamleader.eu/team-name/meeting-rooms/name), search for "teamleader".
...
- 
Click on Add. If the meeting room URL is [https://cloud.teamleader.eu/team-name/meeting-rooms/name](https://cloud.teamleader.eu/team-name/meeting-rooms/name) fill in "[*.]cloud.teamleader.eu". 
...
- 
Click on Manage Exceptions... and add the domain of the meeting roomIf the meeting room URL is [https://cloud.teamleader.eu/team-name/meeting-rooms/name](https://cloud.teamleader.eu/team-name/meeting-rooms/name), add '[https://cloud.teamleader.eu](https://cloud.teamleader.eu)'.
...
- 
Click on Edit, search for the domain name of the meeting room and remove all domain-related entries.Eg. if the meeting room URL is [https://cloud.teamleader.eu/team-name/meeting-rooms/name](https://cloud.teamleader.eu/team-name/meeting-rooms/name), search for "teamleader". 
...
Is the error still not fixed? [Contact the support team](https://support.focus.teamleader.eu/hc/en-150/requests/new?ticket_form_id=25911134514065) for further help and instructions!