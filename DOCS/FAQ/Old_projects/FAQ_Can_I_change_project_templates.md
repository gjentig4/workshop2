---
title: "FAQ: Can I change project templates?"
url: "https://support.focus.teamleader.eu/hc/en-150/articles/25691256023441-FAQ-Can-I-change-project-templates"
locale: "en-150"
created_at: "2024-06-06T07:26:02Z"
...
## 1. Edit the project a template is based on 

Edit the original project your template was based on to change the template accordingly. 

- Select the main project you based your project template on

- Make the changes you want 

- The changes will now be visible in the project template

Don't know the name of the original project? Just use the second method and create a new project template. 

*Note*: the adapted project template will only be used for new projects. The changes to this template won't have an influence on the projects which have already been created with that template.
