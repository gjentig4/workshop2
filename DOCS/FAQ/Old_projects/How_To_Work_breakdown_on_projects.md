---
title: "How To: Work breakdown on projects"
url: "https://support.focus.teamleader.eu/hc/en-150/articles/25697800978065-How-To-Work-breakdown-on-projects"
locale: "en-150"
created_at: "2024-06-06T10:38:28Z"
updated_at: "2025-02-21T11:00:05Z"
category: "FAQ"
...
For phases and tasks: in the side panel, simply click on the field you want to change to edit it and press the Enter button to save your changes. You can also click on the **pencil**.

For meetings: in the side panel, click on the **pencil** to change your meeting details.When you've finished working on a certain task, you can:
...
It's also possible to drag and drop an open task or meeting from one phase to another. Just click on them and drag them to where you want to.This is not possible for:
...
Time tracking on calls

- Time tracking on tasks

- Time tracking on meetings

- Separate time trackings

- 
Time estimated: total time estimated on **all **tasks/meetings of **all **project phases

Remark for meetings: the total time estimated for a meeting is the result of multiplying the duration of the meeting by the number of attendees: it’s all the time you and your colleagues are expected to spend on that meeting.Example: If the duration of a meeting is one hour but there are 6 attendees, then the time estimated will be 6 hours. Make sure every attendee then also individually marks the meeting as done.
...
Find more information on budgeting by navigating to **Project info **in the header and scrolling down to the widget 'Budget spent'. [You can also read more about budget management on projects and the exact calculation of budget spent in this article.](https://support.focus.prd.teamleader.eu/hc/en-us/articles/25693457215889)
...
- When [closing a phase](https://support.focus.prd.teamleader.eu/hc/en-us/articles/25691015006097), the status ‘Done’ will also be assigned to the due date of the phase.
