---
title: "How To: From work order to invoice"
url: "https://support.focus.teamleader.eu/hc/en-150/articles/25690927285777-How-To-From-work-order-to-invoice"
locale: "en-150"
created_at: "2024-06-06T07:14:40Z"
updated_at: "2025-10-20T14:36:46Z"
category: "FAQ"
section: "Work orders"
---
...
There are some different ways to create a work order in Teamleader Focus, but there’s one thing you need to know: **you can’t finish a work order from the web version of Teamleader Focus**. **Finalising a work order is only possible from within the mobile app for **[**Android **](https://play.google.com/store/apps/details?id=eu.teamleader.focus)**or **[**iOS**](https://apps.apple.com/us/app/teamleader-focus/id6453793095)**.**
...
- Prepare your work order from a meeting in Teamleader Focus  
...
- In the Teamleader Focus web app, first make the email template you want to send to your customer. Go to **Settings **> **Work ****Orders **> **Email tem****pl****ates for work orders** and click on the “**+**”-sign. It’s possible to add several different templates which you can choose from. You can also choose the language which could be handy if you also have jobs abroad. 

- Once you made the template you can send it when finalising your work order in the mobile app.
...
- In the web version of Teamleader Focus, navigate to the customer linked to your work order

- You'll find the work order you created in the 'Files' of that customer

- Navigate to 'Unbilled time trackings'. You’ll find a couple of actions you can undertake there:
...
If you’re choosing to create an invoice, the content of the invoice will appear on a new screen. Make some edits if you like and book the invoice. That’s all you have to do to convert a work order to a full invoice!

 

# Invoice a work order out of a project

It’s also possible to invoice a work order out of a project. [Read more about that in this article](https://support.focus.teamleader.eu/hc/en-150/articles/25693045965329-How-To-Invoice-a-work-order-out-of-a-project).

 

Ready to try it yourself? Download the app for free via [Apple App Store](https://apps.apple.com/us/app/teamleader-focus/id6453793095) or the [Google Play Store](https://play.google.com/store/apps/details?id=eu.teamleader.focus) and create a free trial at [https://go.teamleader.eu/trial/try-now](http://www.teamleader.eu/en/free-demo)!