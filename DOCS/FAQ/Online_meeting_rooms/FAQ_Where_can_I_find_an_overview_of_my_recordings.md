---
title: "FAQ: Where can I find an overview of my recordings?"
url: "https://support.focus.teamleader.eu/hc/en-150/articles/25694193966225-FAQ-Where-can-I-find-an-overview-of-my-recordings"
locale: "en-150"
created_at: "2024-06-06T08:57:08Z"
...
- [Where to find the overview?](#Where-to-find-the-overview?)

- [Temporary local recordings vs Cloud recordings](#Temporary-local-recordings-vs-Cloud-recordings)

- 
[Personal and team recordings](#Personal-and-team-recordings)

[Recordings in your meeting rooms](#Recordings-in-your-meeting-rooms)

- [Recordings in meeting rooms of your team](#Recordings-in-meeting-rooms-of-your-team)

- [Recordings in meeting rooms outside of your team](#Recordings-in-meeting-rooms-outside-of-your-team)

- [Recordings in a deleted meeting room](#Recordings-in-a-trashed-or-deleted-meeting-room)

# Where to find the overview?

In every meeting room, you can find the recordings that you created in that specific meeting room. You can find them by clicking on the 'Recordings' button at the bottom of the page.
...
Similar to meeting rooms, you will notice that there are Temporary local recordings and Cloud recordings. We recommend **uploading local recordings to the Cloud**!

 

Temporary local recordings are recordings that are saved in the cache of your browser. Clearing your browser cookies and cache might also delete these recordings. Temporary local recordings can be:
...
- 
Downloaded on your local desktop
...
*Hover over the recording to view the options!*

Cloud recordings are safe from clearing the browser cookies and cache. You will always be able to find them in your meeting rooms or Recordings overview. You can create a shareable link for your cloud recordings, so people don't have to enter the meeting room to watch or download the recording. Cloud recordings can be:

- 
Watched in preview

- 
Shared by a clickable link
...
In the Recordings overview, you are able to see:
...
If you have host rights to a meeting room outside of your team you will see the recordings of that meeting room. The recording can be created by you or any other host of that meeting room.
...
It's possible that you have recorded a meeting in a meeting room that is currently deleted. If a meeting room is deleted there is a difference between whether it was uploaded to the cloud or is saved in your local browser.
...
A recording that was uploaded to the cloud will not show in the list if the meeting room is deleted. The meeting room and all content in it will be removed!