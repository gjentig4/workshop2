---
title: "How To: Create an online meeting room via the Lead capture Booster"
url: "https://support.focus.teamleader.eu/hc/en-150/articles/25695076147601-How-To-Create-an-online-meeting-room-via-the-Lead-capture-Booster"
locale: "en-150"
created_at: "2024-06-06T09:19:30Z"
updated_at: "2025-05-04T13:20:53Z"
category: "FAQ"
...
After you’ve activated the Lead capture Booster in your account, you can go ahead and start creating your online meetings. Read this article to learn how.
...
- 
[Add a meeting in Teamleader Focus](https://support.focus.teamleader.eu/hc/en-150/articles/25691976258193-FAQ-How-do-I-add-a-meeting-in-Teamleader-Focus) via the + in the top right-hand corner of your account, or via **Calendar **> **Meetings **> **Add ****meeting**
...
- When adding an online meeting in Teamleader Focus, [the meeting room templates](https://support.focus.teamleader.eu/hc/en-150/articles/25694091190289-How-To-Create-templates-for-your-online-meeting-rooms) from the Lead capture Booster are not available to choose from. If you want a meeting room based on a template you need to create a personal meeting room in the Lead capture Booster first and then select that specific meeting room when you’re creating the meeting.

- When you’ve synced your Teamleader Focus calendar with [Google Calendar](https://support.focus.teamleader.eu/hc/en-150/articles/25690925270033-How-To-Integrate-Google-Calendar-with-Teamleader-Focus), [iCloud calendar](https://support.focus.teamleader.eu/hc/en-150/articles/25690933196689-How-To-Integrate-iCloud-with-Teamleader-Focus) or [Outlook Calendar](https://support.focus.teamleader.eu/hc/en-150/articles/25690974588305-How-To-Integrate-Microsoft-Exchange-or-Office-365-with-Teamleader-Focus) the online meeting room link will be transferred to that external calendar as well. 

 

## Invite contacts to the meeting

After you’ve created the meeting and - when you’ve created a new meeting room - the meeting room was synced to the Lead capture Booster, it’s time to start adding colleagues and contacts. 

 

***Note**: If you're on the Basic package of the Lead capture Booster, you'll only be able to have 1-on-1 meetings, so with a maximum amount of 2 people in a meeting room. If you use the Beyond package of the Lead capture Booster however, there is a maximum amount of **10 people** in a meeting room, including the host. Read more about the Basic vs Beyond features [here](https://support.focus.teamleader.eu/hc/en-150/articles/25695070912017-The-Lead-capture-Booster-Basic-vs-Beyond-features).*
...
## Add more meeting rooms in the Lead capture Booster

### From the dashboard

The easiest way is to create a meeting room [from the dashboard](https://meeting.teamleader.eu/dashboard/).
...
The second way is to create a meeting room from the meeting rooms page.
