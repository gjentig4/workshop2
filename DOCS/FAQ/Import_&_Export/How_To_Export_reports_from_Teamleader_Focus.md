---
title: "How To: Export reports from Teamleader Focus"
url: "https://support.focus.teamleader.eu/hc/en-150/articles/25691716494225-How-To-Export-reports-from-Teamleader-Focus"
locale: "en-150"
created_at: "2024-06-06T07:41:25Z"
updated_at: "2025-12-12T07:38:09Z"
category: "FAQ"
...
*(Not available in our older *[*GO package*](https://support.focus.teamleader.eu/hc/en-150/articles/25693692738705-Our-GO-package)*) *
...
You can also** export all your projects or a selection of your projects to Excel. **[Read all about it here.](https://support.focus.teamleader.eu/hc/en-150/articles/33056957041041-How-To-Export-projects-from-Teamleader-Focus)

 

## Global HR report

*(Available in *[*MOVE *](https://support.focus.teamleader.eu/hc/en-150/articles/25693707105297-Our-MOVE-package)*& *[*BOOST *](https://support.focus.prd.teamleader.eu/hc/en-us/articles/25693667750929)*and in *[*GROW & FLOW*](https://support.focus.teamleader.eu/hc/en-150/articles/25696098299537-Features-per-package-SMART-GROW-FLOW)*)*
...
 
    ...
    *Notes: *
    ...
    - 
      Note you can only export a report to
      Excel, the PDF report is only available
      in BOOST and FLOW.
...
### 
*Features included in our *[*Bo**ost*](https://support.focus.teamleader.eu/hc/en-150/articles/25697618837009-Features-per-package-GO-MOVE-BOOST)* and *[*FLOW *](https://support.focus.teamleader.eu/hc/en-150/articles/25696098299537-Features-per-package-SMART-GROW-FLOW)*pa**ckages:*
...
## Time tracking report
    ...
    *Boost and Flow *packages
    is that you can choose whether you wish
    to receive the time tracking report as a PDF or Excel file.
...
The time tracking report in PDF contains the following items:
    ...
    - 
      Objectives: has the predetermined goal been met in terms of billable
      hours?
    

    - 
      Division of tasks: an overview of the number of hours pertaining to a
      certain work type
...
If you've set individual [targets ](https://support.focus.teamleader.eu/hc/en-150/articles/25691312824465-How-To-Adding-Targets)on the billable vs non-billable time of a user, you can also export a report of that performance.
...
If you navigate to **Settings **> **Holiday management**, you will see the [closing days](https://support.focus.teamleader.eu/hc/en-150/articles/25691773689873-How-To-Working-with-closing-days-in-Teamleader-Focus) of your company at the bottom of your screen. Here, you can enter general closing days or [download a report of all the users' days off.](https://support.focus.teamleader.eu/hc/en-150/articles/25691041895953-How-To-Creating-an-overview-of-my-colleagues-leaves-in-Teamleader-Focus)
