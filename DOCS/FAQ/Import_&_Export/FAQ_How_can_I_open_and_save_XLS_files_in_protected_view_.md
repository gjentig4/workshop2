---
title: "FAQ: How can I open and save XLS files in protected view ?"
url: "https://support.focus.teamleader.eu/hc/en-150/articles/25692358987153-FAQ-How-can-I-open-and-save-XLS-files-in-protected-view"
locale: "en-150"
created_at: "2024-06-06T08:03:02Z"
...
In order to make it possible to edit and save this file, some changes need to happen in the Trust Center of Excel. The steps described below apply to Office 2016.
...
5. In order to be able to start working with the file, we advise to save it in a XLSX-format.

6. For security reasons, it is advisable to change those settings back to default afterwards.