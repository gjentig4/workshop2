---
title: "How To: Integrate Teamleader Focus with Zapier"
url: "https://support.focus.teamleader.eu/hc/en-150/articles/25693119585425-How-To-Integrate-Teamleader-Focus-with-Zapier"
locale: "en-150"
created_at: "2024-06-06T08:24:08Z"
...
Over the past few years, Teamleader Focus has integrated with a lot of different applications in the process of becoming an all-in-one tool. The next big step in this process is our participation in one of the biggest software integrating tools: Zapier.
...
The available **triggers **for Teamleader Focus are:
...
### Examples of zaps with Teamleader Focus

 

- 
[Web2Lead](https://support.focus.teamleader.eu/hc/en-150/articles/25693152447121-How-To-Link-your-online-form-to-Teamleader-Focus-via-Zapier): A lead fills in a form on your website, which creates a new company, a new linked contact and a new deal in Teamleader Focus.
...
Zapier is free up until a number of connections. However, if you plan on creating multi-step zaps, use premium apps, etc. you can choose to transfer to a paying license. The big advantage here is that you get to use license to create zaps between other apps than just Teamleader Focus. Find out all about pricing and plans [here](https://zapier.com/app/billing/plans).

Find more advanced tutorials on the [“Zapier University” Youtube channel](https://www.youtube.com/user/ZapierApp).