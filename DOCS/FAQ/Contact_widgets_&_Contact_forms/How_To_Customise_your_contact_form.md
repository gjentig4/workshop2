---
title: "How To: Customise your contact form"
url: "https://support.focus.teamleader.eu/hc/en-150/articles/25695981899409-How-To-Customise-your-contact-form"
locale: "en-150"
created_at: "2024-06-06T09:46:41Z"
...
After [you’ve created your contact form](https://support.focus.teamleader.eu/hc/en-150/articles/25695775141649-How-To-Contact-forms-and-how-to-create-them), formulated the right questions and linked them to Teamleader Focus, the next step is to customise your contact form. When you embed the contact form in your website, customising it makes sure it matches the aesthetic of your brand and website. 
...
- [Embed the customised form in your website](#Embed-the-customised-form-in-your-website)

## What

Every user is able to add page specifics such as an introduction, button text and a success page with an image. You can find the page specifics on the right side of ‘Customise your form’.

Customers on the [Beyond package](https://support.focus.teamleader.eu/hc/en-150/articles/25695070912017-The-Lead-capture-Booster-Basic-vs-Beyond-features) have the option to personalise the form by adding their own logo, using their brand's colours, and matching it to their brand’s style. All of this can be set up on the left side of the screen below "General."
...
- Choosing a colour works the same as with the text colour. Fill out the hex code, choose a colour from the palette or use the pin. For example, here the hex code #e1e1c7 is used which is a neutral beige. 
...
- You’re able to personalise the introduction and the text that appears on the button in the right side corner. 
...
- Customise the title text as wanted. For example you can change it to 'Great succes'. 

- Add a personalised success message, such as ''Thank you for filling in the contact form, we will be in contact shortly.' 
...
## Embed the customised form in your website

You can embed this customised form in your website so it looks like it’s a fixed part of the website. Copy the embedded HTML from the [Contact forms overview page.](https://meeting.teamleader.eu/contact-forms/) In the example below you can see the contact form created above as example embedded in a website. 
...
To learn more on how to embed the contact form in your website, [follow the steps in this article.](https://support.focus.teamleader.eu/hc/en-150/articles/25695815664401-How-To-Embed-a-contact-form-in-your-website)