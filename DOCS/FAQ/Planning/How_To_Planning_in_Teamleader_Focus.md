---
title: "How To: Planning in Teamleader Focus"
url: "https://support.focus.teamleader.eu/hc/en-150/articles/25696175894929-How-To-Planning-in-Teamleader-Focus"
locale: "en-150"
created_at: "2024-06-06T09:52:54Z"
updated_at: "2026-01-02T13:46:07Z"
category: "FAQ"
section: "Planning"
---
...
Discover the Planning Module or – your key to streamlined management. Read in this article how this module optimises scheduling, maximises resource usage, and helps you plan for the future. With Teamleader Focus’ established Planning Booster, your coordination becomes very easy, ensuring your team's time is used efficiently and your tasks are well-organised and adaptable. Let's dive into the planning process!
...
- [Link with the calendar module](#Link-with-the-calendar-module)

- [Link with timesheets](#h_01J2K5JK84NB18VD6HHZTEYFZV)

- [Access to planning](#h_01J0V1A3BTJFX2X11AKRBA5921)
...
The Teamleader Focus Planning can help you improve your way of working:
...
*Note*: Our planning module differs from our [calendar module,](https://support.focus.teamleader.eu/hc/en-150/sections/25085616010257) as the planning only offers an overview in which you can plan and reschedule tasks. You can’t see at what time a certain task is planned.
...
- 
You can choose to display the **work type colour of your tasks **in your planning (cf. [Settings > Calendar > Work types](https://support.focus.teamleader.eu/hc/en-150/articles/25691899451153-FAQ-Can-I-add-extra-work-types))
...
*Note*: You cannot [create tasks](https://support.focus.teamleader.eu/hc/en-150/articles/25691951764497-FAQ-How-do-I-add-a-task-in-Teamleader-Focus) in the planning module. You have to create the task via the calendar or by clicking on the plus and then "task" at the top.
...
- If you have a [BOOST ](https://support.focus.teamleader.eu/hc/en-150/articles/25693667750929-Our-BOOST-package)or [FLOW ](https://support.focus.teamleader.eu/hc/en-150/articles/25696098299537-Features-per-package-SMART-GROW-FLOW)licence, you can also determine your **days off.** That day will be **displayed in grey**. If you try to plan a task that day, the capacity bar will turn red as well. 

 

If you **click on a task,** you can see on which date and how long the task is scheduled, the customer name, the project title and work type. 

- 
If you click on the **pencil**, you can **edit **the planned time.
...
- 
If you click on the **three dots you **have three options:

View task details: A task side panel opens in which you can edit the task details.

- Track time: Immediately add time tracking from a planned task.

- 
Remove planned time: By clicking on this, you delete the planned time in the planning, but not the actual task itself.
*Note: you can also view these three options by right-clicking on a task in the planning.*

 

To **r****eschedule a task** and move it to another colleague or to another day, you can always **drag and drop** the task to someone else/another day.
...
You can also quickly convert your planning to timesheets for an entire period, saving you time and hassle. [Read this article to find out](https://support.focus.teamleader.eu/hc/en-150/articles/26653504659089-How-To-Convert-your-planning-to-timesheets-in-Teamleader-Focus) how this can further boost your productivity and efficiency.
