...
url: "https://support.focus.teamleader.eu/hc/en-150/articles/25695672586001-How-To-Invoice-a-project-in-Teamleader-Focus"
locale: "en-150"
created_at: "2024-06-06T09:37:00Z"
updated_at: "2026-01-09T15:46:41Z"
category: "FAQ"
section: "Projects"
---
...
- 
[Via the invoices tab](#01JAQM0ZTGSNM34Z870Z3S369B)

[Create invoice from project lines](#01JAQM0ZTKD7DCY856EMT63CR1)

- [Create blank invoice](#01JAQM0ZTTEAS4EA139S9F6J8Y)

- [Create advance invoice](#h_01JPA3ZATZJY475HYR879N2RSW)

- [In bulk via the projects overview page](#01JAQM0ZTW0SK8J64JV26ZH46S)

- [Credit notes](#h_01JJYBG2H0X33PG2JY41ZTRKSC)
...
*Note that it's not possible to select project lines from multiple projects and merge these onto one invoice. You can only select project lines from the project you're currently in.*
 
...
If the [billing method](https://support.focus.teamleader.eu/hc/en-150/articles/25695653109393-How-To-Billing-methods-in-a-project) of your task/material/group is ‘Fixed price’, then it’s possible to only invoice part of the amount of the fixed price based on a **percentage**. 
...
It is possible to create a negative invoice for a project based on negative material lines, as long as the invoice does not subtract any advance invoices. This allows you to create a credit invoice for a project where no advance was involved. If an invoice does subtract advance invoices, it cannot be made negative using this feature.
 
...
- Choose the specific amount or percentage of the project price for which you want to add an advance invoice.
...
- When you open your new invoice you'll see a remark has been added to the invoice stating that the advance invoice 'xxxx' has been added.
 
...
- Create an invoice through the menu 'Revenue > Invoices' directly, and via the button ‘Add invoice’ you can manually select the project
