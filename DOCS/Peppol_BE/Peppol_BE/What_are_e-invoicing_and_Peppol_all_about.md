---
title: "What are e-invoicing and Peppol all about?"
url: "https://support.focus.teamleader.eu/hc/en-150/articles/38947178910353-What-are-e-invoicing-and-Peppol-all-about"
locale: "en-150"
created_at: "2025-09-11T09:10:38Z"
updated_at: "2026-01-02T12:18:25Z"
category: "Peppol 🇧🇪"
section: "Peppol 🇧🇪"
---
...
- [E-invoicing & country-specific implementation](#01JCQXVGCMQVNC8YW2KG1F8J5S)

- [What is Peppol?](#01JCQXVGEV4WCXQASFYBC09HSQ)
...
! Sending invoices to the Dutch government (they are using the software Digipoort), is already mandatory via Peppol.
 
...
For specific information about e-invoicing in Italy, [please consult the following article.](https://support.focus.teamleader.eu/hc/en-150/articles/25693046603665-How-To-Activating-Italian-e-invoicing-functionality-in-Teamleader-Focus)
 
...
- You need software to send and receive e-invoices via Peppol and this is where Teamleader Focus comes in.

- Your customer needs to be registered on Peppol too, no matter which tool (could be Teamleader Focus or not).

- The software gives you something to identify yourself with: a **Peppol ID**. For Belgium, this is a unique code and consists of the prefix 0208 combined with your KBO number, or 9925 combined with your VAT number.

- You can send the UBL together with the PDF from Teamleader Focus to your customer's software, and it's readable. You send based on your Peppol ID to the other participant's Peppol ID.
...
- You can **send invoices using different software** tools by **connecting **to Peppol. [Read more about sending invoices through Peppol here.](https://support.focus.teamleader.eu/hc/en-150/articles/30085139646225-How-To-Sending-e-invoices-via-Peppol-in-Teamleader-Focus)

- However, you can only **register with one software tool.** When you register, you indicate that you want to receive your invoices in that tool. [Read more about receiving invoices through Peppol here.](https://support.focus.teamleader.eu/hc/en-150/articles/28079545197713-How-To-Receiving-e-invoices-via-Peppol-in-Teamleader-Focus)
...
Ready now to enable Peppol in your Teamleader Focus account and start sending and receiving e-invoices? [Read all about it here!](https://support.focus.teamleader.eu/hc/en-150/articles/25693204310673-How-To-Enable-Peppol-in-Teamleader-Focus)