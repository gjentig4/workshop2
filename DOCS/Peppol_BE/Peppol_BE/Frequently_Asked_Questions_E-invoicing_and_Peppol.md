---
title: "Frequently Asked Questions E-invoicing and Peppol"
url: "https://support.focus.teamleader.eu/hc/en-150/articles/30083675838609-Frequently-Asked-Questions-E-invoicing-and-Peppol"
locale: "en-150"
created_at: "2024-11-15T09:16:10Z"
updated_at: "2026-01-02T12:17:22Z"
category: "Peppol 🇧🇪"
section: "Peppol 🇧🇪"
---
...
*E-invoicing is set to become mandatory in all European countries by 2030. For Belgium, e-invoicing already became mandatory on 01/01/2026. Find out all about e-invoicing and enabling Peppol *[***here ***](https://support.focus.teamleader.eu/hc/en-150/articles/25693204310673-How-To-What-is-e-invoicing-and-how-do-I-enable-Peppol-in-Teamleader-Focus)*or *[***set it up in Teamleader Focus.***](https://focus.teamleader.eu/settings.php#company_information)
 

- [General](#01JCQHG905H468QYQ53Z30ZWAT)

- [Registering on Peppol](#h_01JCQJ34XX9NT39283G45BC2DY)

- [Sending e-invoices](#01JCQHG92C2GN2X34V9RYQ4Q6S)

- [Receiving e-invoices](#01JCQHG938GG032CMTJE5TPYMB)

- [Bookkeeping](#h_01JCQJ4EEVTEXG7TPAQ1D1PBBZ)

- [Archive/delete company entity or downgrade/churn](#h_01JCQJ4SWTNNMQ2998ATWRV59R)
...
No, only to other BE companies. You can still use regular email to send your invoices to other countries. It's however possible to send invoices via Peppol to Dutch and Luxembourg companies from your Belgian company entity.
 

**As a non-Belgian company, do I need to send invoices via Peppol to my BE customers? **

No for B2B: You can send invoices to your Belgian customer via email. 
 

Yes for B2G: If you send invoices to the Belgian/Dutch government, you need to use Peppol. 
...
Receiving invoices via Peppol is also available for all packages but the only exception are users of the [SMART package.](https://support.focus.teamleader.eu/hc/en-150/articles/25696098299537-Features-per-package-SMART-GROW-FLOW)
 
...
No, Italy does not use Peppol for its e-invoices. And even if other countries do use Peppol, there are subtle differences per country. We’ll be developing e-invoicing for Germany first, because Germany will introduce Peppol in 2025 already. After that, we’ll keep you posted on which countries are next.
 
...
However, you can only register with one software tool. When you register, you indicate that you want to receive your invoices in that tool.
 

**How can my suppliers know I’m registered on Peppol and how can they find me? **

They can find you based on your KBO number (BCE in Wallonia). Your KBO number in Belgium is your VAT number without the “BE” (so only the numbers). Via the website [peppolscanner.be](https://peppolscanner.be/) they can also check if and where you're registered on Peppol.
 
...
Know that you can also check for yourself if a company is already registered on Peppol via the website [peppolscanner.be](https://peppolscanner.be/). 
...
Customers who are not compliant after 01/01/2026 risk financial penalties:
...
Yes! Invoices to the Belgian and Dutch government (B2G) should also be sent through Peppol. This is also possible in Teamleader Focus as we can identify these government instances too. 
 

**What for invoices that are sent automatically via subscriptions?**

Invoices that are sent automatically via subscriptions will also automatically be sent via Peppol if this option is enabled. [Read all about that here.](https://support.focus.teamleader.eu/hc/en-150/articles/25691807856785-FAQ-Can-invoices-from-subscriptions-be-sent-automatically)

**What if I receive an error message after sending?**

You may get a message after sending a Peppol invoice that your invoice has been rejected for the following reason: ‘IO (97) must contain at least 8 numbers’. [This is because you have not entered a purchase order number or PO number. ](https://support.focus.teamleader.eu/hc/en-150/articles/25692069252497-FAQ-How-do-I-add-a-PO-number-to-an-invoice)

- Firstly, you need to enable this setting (Go to **Settings **> **Revenue **> **Preferences **> 'Use PO numbers on your invoices'). From now on, you will be able to enter a PO number when creating an invoice.

- Secondly, you cannot edit an invoice and resend it via Peppol. Therefore you need to make a credit note of the already sent invoice, copy the original invoice, update it to enter the PO number and send the new one via Peppol.
 
...
At this point in time, no. We will be working on a solution for this though. In the meantime [you can work with Ponto to set your invoices to paid in Teamleader Focus.](https://support.focus.teamleader.eu/hc/en-150/articles/25697624265361-How-To-Setting-invoices-to-paid-with-Ponto)
 
...
You can still sync outgoing invoices to your [bookkeeping software](https://support.focus.teamleader.eu/hc/en-150/articles/25691318213393-FAQ-What-are-the-available-bookkeeping-integrations-in-Teamleader-Focus-per-country) via Teamleader Focus (if you have an integration), even if they are sent via Peppol.
 

**Can I send incoming invoices to my bookkeeping software?**

At this time, there is no option to automatically sync incoming invoices to your bookkeeping integration [as is possible with outgoing invoices](https://support.focus.teamleader.eu/hc/en-150/articles/25691318213393-FAQ-What-are-the-available-bookkeeping-integrations-in-Teamleader-Focus-per-country). We will work on this in the future though. For now, you can download your invoice via UBL/PDF and manually upload it in your bookkeeping software.
 
