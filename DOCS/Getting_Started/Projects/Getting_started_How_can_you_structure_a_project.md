---
title: "Getting started: How can you structure a project?"
url: "https://support.focus.teamleader.eu/hc/en-150/articles/25692436076177-Getting-started-How-can-you-structure-a-project"
locale: "en-150"
created_at: "2024-06-06T08:04:04Z"
updated_at: "2025-05-03T19:55:26Z"
...
![](https://support.focus.teamleader.eu/hc/article_attachments/25692409132177)

 

Projects basically help you divide the workload, all tasks and actions that need to be performed to deliver your services - whether those are [based on a deal](https://support.focus.teamleader.eu/hc/en-150/articles/25691286414737-FAQ-How-can-I-convert-a-deal-or-quotation-into-a-project) or not. Here we'll discuss how you can structure your project.
...
Now then, as we mentioned in the beginning, we should first determine how we will invoice our project. If you'd like to send out invoices on a monthly basis, you should set up your groups accordingly - one for each month. If you want to invoice different steps of your projects, e.g. "buying a plot of land", "hiring an architect", then you should create groups that correspond with each of those steps. Click [here](https://support.focus.teamleader.eu/hc/en-150/articles/25695672586001-How-To-Invoice-a-project-in-Teamleader-Focus) to learn more about how to invoice a project. 

 

Basically, the **groups **help you keep an overview of what needs to happen by when. [Click here if you want to learn more about the work breakdown on projects.](https://support.focus.teamleader.eu/hc/en-150/articles/25695560896145-How-To-Add-a-project-in-Teamleader-Focus) 
...
Once you've found structures that work best for you, you can [duplicate projects](https://support.focus.teamleader.eu/hc/en-150/articles/25695832552593-How-To-Duplicate-a-project-in-Teamleader-Focus). This way, you won't have to create groups and corresponding tasks over and over again.

 

You'll probably realize - after having laid the foundation by setting up new groups - that working in a team often helps. So let's check how you can cooperate by using projects. In each project, you mostly have one person who takes decisions and multiple people that contribute. Teamleader Focus offers you the option to grant [different rights to colleagues](https://support.focus.teamleader.eu/hc/en-150/articles/25695680166801-FAQ-What-are-the-different-rights-in-a-project) based on their role.
...
Click here to read the next part: [Getting started: How can you add work and external costs to a project?](https://support.focus.teamleader.eu/hc/en-150/articles/25692461409297-Getting-started-How-can-you-add-work-and-materials-to-a-project)